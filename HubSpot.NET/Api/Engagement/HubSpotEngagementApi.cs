...
namespace HubSpot.NET.Api.Engagement
{
    public class HubSpotEngagementApi : IHubSpotEngagementApi
    {
        ...
        public EngagementHubSpotModel Create(EngagementHubSpotModel entity) 
            => _client.Execute($"{entity.RouteBasePath}/engagements", entity, Method.POST, false);
        ...
        public void Update(EngagementHubSpotModel entity)
        {
            ...
            _client.Execute($"{entity.RouteBasePath}/engagements/{entity.Engagement.Id}", entity, Method.PATCH, false);
        }
        ...
        public EngagementHubSpotModel GetById(long engagementId) 
            => _client.Execute<EngagementHubSpotModel>($"{new EngagementHubSpotModel().RouteBasePath}/engagements/{engagementId}", convertToPropertiesSchema: false);
        ...
        public void Delete(long engagementId)
            => _client.Execute($"{new EngagementHubSpotModel().RouteBasePath}/engagements/{engagementId}", method: Method.DELETE);
        ...
        public void Associate(long engagementId, string objectType, long objectId) 
            => _client.Execute($"{new EngagementHubSpotModel().RouteBasePath}/engagements/{engagementId}/associations/{objectType}/{objectId}", method: Method.PUT);
